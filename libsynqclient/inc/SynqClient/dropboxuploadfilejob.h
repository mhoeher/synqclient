...
#ifndef SYNQCLIENT_DROPBOXUPLOADFILEJOB_H
#define SYNQCLIENT_DROPBOXUPLOADFILEJOB_H
...
class DropboxUploadFileJobPrivate;

class LIBSYNQCLIENT_EXPORT DropboxUploadFileJob : public UploadFileJob, public AbstractDropboxJob
{
    Q_OBJECT
public:
...
protected:
    ...
    Q_DECLARE_PRIVATE(DropboxUploadFileJob);
};

} // namespace SynqClient

#endif // SYNQCLIENT_DROPBOXUPLOADFILEJOB_H
